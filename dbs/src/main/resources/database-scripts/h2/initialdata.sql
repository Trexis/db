...
insert into Tenants (name, description) values ('demobank', 'demobank');
...
insert into Components(tenantname, appname, pagename, name, title) values ('demobank', 'default', 'index', '1', 'test1');
insert into Links (tenantname, appname, parentlinkname, name, url, pagename) values ('demobank', 'default', '', 'home', '/', 'index');
...
insert into Components(tenantname, appname, pagename, name, title) values ('demobank', 'default', 'about', '2', 'test2');
insert into Links (tenantname, appname, parentlinkname, name, url, pagename) values ('demobank', 'default', '', 'about', '/aboutus', 'about');

insert into Pages (tenantname, appname, name, title, isapplicationpage) values ('demobank', 'siteb', 'dashboard', 'Demo Bank Dashboard', 0);
insert into Components(tenantname, appname, pagename, name, title) values ('demobank', 'siteb', 'dashboard', '3', 'test3');
insert into Links (tenantname, appname, parentlinkname, name, url, pagename) values ('demobank', 'siteb', '', 'dashboard', '/', 'dashboard');


insert into Tenants (name, description) values ('bankx', 'Bank X');
...
insert into Components(tenantname, appname, pagename, name, title) values ('bankx', 'default', 'index', '1', 'test1');
insert into Links (tenantname, appname, parentlinkname, name, url, pagename) values ('bankx', 'default', '', 'home', '/', 'index');
...
insert into Components(tenantname, appname, pagename, name, title) values ('bankx', 'default', 'dashboard', '1', 'test2');
insert into Links (tenantname, appname, parentlinkname, name, url, pagename) values ('bankx', 'default', '', 'dashboard', '/dashboard', 'about');
